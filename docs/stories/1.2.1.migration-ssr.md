...
- `/utils/supabase/client.ts` - Client browser selon doc officielle
- `/utils/supabase/server.ts` - Client server selon doc officielle
- `/utils/supabase/middleware.ts` - Middleware selon doc officielle
